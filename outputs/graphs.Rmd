...
```{r}
interaction.plot(tiny_dhs$illiterate, tiny_dhs$antenatal, tiny_dhs$births)
interaction.plot(tiny_dhs$illiterate, tiny_dhs$antenatal, tiny_dhs$immunized)

interaction.plot(tiny_dhs$illiterate, tiny_dhs$water, tiny_dhs$births)
interaction.plot(tiny_dhs$illiterate, tiny_dhs$water, tiny_dhs$immunized)

interaction.plot(tiny_dhs$antenatal, tiny_dhs$water, tiny_dhs$births)
interaction.plot(tiny_dhs$antenatal, tiny_dhs$water, tiny_dhs$immunized)
```
