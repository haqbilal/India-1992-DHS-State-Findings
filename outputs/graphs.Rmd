...
nigib1 <- data.frame(tiny_dhs$States, tiny_dhs$`Percent of illiterate females`, tiny_dhs$`Percent of mothers receiving antenatal care`)
colnames(nigib1) <- c("States", "Illiterate Females", "Antenatal Care")
nigib2 <- reshape2::melt(nigib1, id.vars = 'States')
