...
state_names <- c("India", "Delhi", "Haryana", "Himachal Pradesh", "Jammu & Kashmir", "Punjab", "Rajasthan", "Madhya Pradesh", "Uttar Pradesh", "Bihar", "Orissa", "West Bengal", "Arunachal Pradesh", "Assam", "Manipur", "Meghalaya", "Mizoram", "Nagaland", "Tripura", "Goa", "Gujarat", "Maharashtra", "Andhra Pradesh", "Karnataka", "Tamil Nadu")
